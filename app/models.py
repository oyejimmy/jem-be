...
# Master products table containing all products
class Products(Base):
    __tablename__ = "products"
    id = Column(Integer, primary_key=True, index=True)
    name = Column(String)           # e.g., Anklet 1
    collection = Column(String)     # e.g., anklets, bangles, bracelets
    ...
    images = Column(Text)           # comma-separated images
    available = Column(Integer, default=0)
    sold = Column(Integer, default=0)


# Individual collection tables
class Anklet(Base):
